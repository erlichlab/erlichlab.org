...
We are specifically looking for people with a strong programming / machine learning background for positions that will be a combination of 50% research (computational neuroscience) and 50% software engineering (building and maintaining our automated behavioral training facility at SWC). If you are applying for this position, please include a link to your github (or gitlab / bitbucket / etc) account and/or a code sample. Specificy whether you have experience with python, SQL, SQLAlchemy, and Pydantic.
